...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _values = {
    'vi': {
      ...
      'confirm': 'Xác nhận',
      'vehicleOther': 'Khác',
      'vehicleStatusAvailable': 'Đang cho thuê',
      'vehicleStatusRented': 'Đang thuê',
      'vehicleStatusMaintenance': 'Bảo trì',
      'vehicleStatusPending': 'Chờ duyệt',
      'vehicleStatusRejected': 'Từ chối',
      'vehicleStatusLocked': 'Đã khóa',
      'vehicleStatusUnavailable': 'Tạm tắt',
      'vehicleTypeElectricScooter': 'Xe tay ga điện',
      'vehicleTypeElectricMotorcycle': 'Xe máy điện',
      'vehicleTypeElectricBike': 'Xe đạp điện',
      'vehicleFeatureReplaceableBattery': 'Pin tháo rời',
      'vehicleFeatureFastCharging': 'Sạc nhanh',
      'vehicleFeatureDifficultTerrain': 'Đi địa hình',
      'vehicleFeatureGpsTracking': 'Định vị GPS',
      'vehicleFeatureAntiTheft': 'Chống trộm',
      'vehicleCustomModel': 'Mẫu khác',
      'vehicleModelField': 'Loại xe / model',
      'vehicleModelHint': 'Chọn loại xe hoặc model',
      'vehicleCustomModelHint': 'VD: VinFast Evo200',
    },
    'en': {
      'appTitle': 'DreamRide',
      ...
      'confirm': 'Confirm',
      'vehicleOther': 'Other',
      'vehicleStatusAvailable': 'For rent',
      'vehicleStatusRented': 'Rented',
      'vehicleStatusMaintenance': 'Maintenance',
      'vehicleStatusPending': 'Pending',
      'vehicleStatusRejected': 'Rejected',
      'vehicleStatusLocked': 'Locked',
      'vehicleStatusUnavailable': 'Unavailable',
      'vehicleTypeElectricScooter': 'Electric scooter',
      'vehicleTypeElectricMotorcycle': 'Electric motorcycle',
      'vehicleTypeElectricBike': 'Electric bike',
      'vehicleFeatureReplaceableBattery': 'Replaceable battery',
      'vehicleFeatureFastCharging': 'Fast charging',
      'vehicleFeatureDifficultTerrain': 'Difficult terrain support',
      'vehicleFeatureGpsTracking': 'GPS tracking',
      'vehicleFeatureAntiTheft': 'Anti-theft system',
      'vehicleCustomModel': 'Other model',
      'vehicleModelField': 'Vehicle type / model',
      'vehicleModelHint': 'Select vehicle type or model',
      'vehicleCustomModelHint': 'E.g. VinFast Evo200',
    },
  };
